...
public class ReservationController {
    ...
    @GetMapping("/byDate")
    public ResponseEntity<Object> getReservationsByDate(@RequestParam String dateFrom, @RequestParam String dateTo){
        ...
        List<ReservationDto> reservations = reservationService.getReservationsByDate(parsedDateFrom, parsedDateTo);
        return ResponseEntity.ok(reservations);
    }
